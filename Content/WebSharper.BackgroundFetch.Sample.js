...
(function(Global)
{
 ...
 WebSharper$BackgroundFetch$Sample_Templates=Global.WebSharper$BackgroundFetch$Sample_Templates=Global.WebSharper$BackgroundFetch$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_BackgroundFetch_Sample$Client=Global.StartupCode$WebSharper_BackgroundFetch_Sample$Client||{};
 ...
 {
  var _,b,t,_this,p,i;
  _=(b=(t=(_this=new ProviderBuilder.New$1(),(_this.h.push(new TextView.New("status",Client.status().get_View())),_this)),(t.h.push(Handler.EventQ2(t.k,"startbackgroundfetch",function()
  {
   return t.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.startBackgroundFetch()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$BackgroundFetch$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Client.startBackgroundFetch=function()
 {
  var _;
  function f()
  {
   ...
   {
    var serviceWorker;
    serviceWorker=self.navigator.serviceWorker;
    return!serviceWorker.controller?serviceWorker.register("service-worker.js").then(function()
    {
     return Promise$1.resolve(null);
    }):serviceWorker.ready.then(function(a)
    {
     return a.backgroundFetch.fetch("file-download",["https://th.bing.com/th/id/OIP.kNs4ljTKUnPaBhUzwTScvwHaE8?rs=1&pid=ImgDetMain"]).then(function(a$1)
     {
      Client.status().Set("Downloading in the background...");
      a$1.addEventListener("progress",function()
      {
       return Client.status().Set("Downloaded "+Global.String(a$1.downloaded)+" of "+Global.String(a$1.downloadTotal)+" bytes");
      });
      return Promise$1.resolve(null);
     });
    });
   ...
   {
    var $1;
    Client.status().Set("Background fetch failed!");
    $1=a.message;
    (function($2)
    {
     return $2("Background Fetch Error: "+Global.String($1));
    }(function(s)
    {
     console.log(s);
    }));
 ...
 WebSharper$BackgroundFetch$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.status=Var$1.Create$1("Click the button to start downloading...");
 };
